  ...
  <div class="container">
    <div class="row justify-content-center mt-5">
      <div class="col-md-6">
        ...
        <p class="text-white">fill the form below to creat account </p>
        ...
        <form action="includes/registersub.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="name" class="form-label  text-white">fullName</label>
          ...
          <span> have account ?<a href="../restaurant_updated/login.php"> login</a></span>
        </form>
