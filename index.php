                ...
                <div class="container my-5 py-5">
                    <div class="row align-items-center g-5">
                        ...
                        <div class="col-lg-6 text-center text-lg-end overflow-hidden">
                            <img class="img-fluid" src="img/Download_Country_Potato_w__Greens_on_Plate_Transparent_PNG_on_YELLOW_Images-removebg-preview.png" alt="" style="border-radius: 50%;">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-6 bg-dark d-flex align-items-center">
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <form action="includes/indexbookingsub.php" method="post">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating date" id="date3" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input" name="dateandtime" placeholder="Date & Time" data-target="#date3" data-toggle="datetimepicker" />
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control" placeholder="Special Request" name="request" style="height: 100px"></textarea>
